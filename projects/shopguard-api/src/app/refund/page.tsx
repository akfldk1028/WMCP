    ...
    <>
      ...
      <div className="legal-page container-narrow">
        ...
        <div className="legal-content fade-up fade-up-d2">
          <h2>Free Trial</h2>
          <p>All paid plans (Seller, Developer) include a <strong>14-day free trial</strong>. During the trial, you have full access to your plan{`'`}s features at no charge. If ShopGuard is not right for you, simply cancel before the trial ends and you will not be charged.</p>
